...
```bash
onnx-codegen --onnx model.onnx --out-dir output/ --prefix my_model --quant 8w8a --rogue 0
```
Or, to enable Rogue kernels:

```bash
onnx-codegen --onnx model.onnx --out-dir output/ --prefix my_model --quant 8w8a --rogue 1
```
